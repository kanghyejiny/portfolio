$(function () {
    ScrollTrigger.matchMedia({
        ...
        "(min-width: 1024px)": function () {
            ...
            // INTRO 서브 타이틀에 마우스를 가져다될때 
            $(".sc-intro .sub-tit").mousemove(function (e) {
                var x = ((-$(this).width() / 2) + e.offsetX) * 0.3;
                var y = ((-$(this).height() / 2) + e.offsetY) * 0.3;
                gsap.to(".sc-intro .intro-tit", {
                    transform: "translate(" + x + "px," + y + "px)"
                });
            });
            // INTRO 서브 타이틀에 마우스를 out
        ...
        "all": function () {
            ...
            loadingAni.addLabel('a')
                .to('.loading .list1', { y: '-200vw', duration: 4 }, 'a') /* K까지 */
                .to('.loading .list2', { y: '-140vw', duration: 5 }, 'a') /* H까지 */
                .to('.loading .list3', { y: '-180vw', duration: 4 }, 'a') /* J까지 */
